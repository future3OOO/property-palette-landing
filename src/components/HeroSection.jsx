...
import { ArrowRight, Phone, Sparkles, Shield } from 'lucide-react';
...
const HeroSection = () => {
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden bg-cream dark:bg-charcoal">
      ...
      <div className="absolute top-1/2 left-0 h-px w-full bg-gradient-to-r from-transparent via-deep-teal/20 dark:via-light-teal/20 to-transparent" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="bg-deep-teal hover:bg-soft-teal text-white dark:bg-light-teal dark:hover:bg-bright-teal dark:text-deep-teal font-medium transition-all group rounded-full px-8 py-7 h-auto shadow-lg hover:shadow-xl hover:scale-105 duration-300"
              >
                Get Started Now
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-deep-teal hover:bg-deep-teal/5 text-deep-teal dark:border-light-teal dark:hover:bg-light-teal/5 dark:text-light-teal transition-all group rounded-full hover:scale-105 duration-300"
              >
