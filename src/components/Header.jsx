...
const Logo = memo(() => (
  ...
  >
    ...
    <span className="ml-1.5 sm:ml-2 text-base sm:text-lg md:text-lg font-bold">
      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <nav className="hidden lg:flex items-center space-x-4 xl:space-x-6 flex-1 justify-center" 
            ...
            <Link 
              to="/pricing" 
              className="px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-deep-teal dark:hover:text-bright-teal transition-colors font-medium"
            >
              Pricing
            </Link>
            <ContactDialog>
              <Button variant="ghost" className="text-gray-700 dark:text-gray-300 hover:text-deep-teal dark:hover:text-bright-teal transition-colors font-medium px-3 py-2 h-auto">
                Contact
              </Button>
            </ContactDialog>
          </nav>
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              >
                <nav className="flex flex-col space-y-3 mt-6 p-4">
                  ...
                  <Link 
                    to="/pricing" 
                    className="block text-base text-gray-700 dark:text-gray-300 hover:text-deep-teal dark:hover:text-light-teal px-2 py-2"
                  >
                    Pricing
                  </Link>
                  <ContactDialog>
                    <Button variant="ghost" className="w-full justify-start text-base text-gray-700 dark:text-gray-300 hover:text-deep-teal dark:hover:text-light-teal h-auto py-2">
                      Contact
                    </Button>
                  </ContactDialog>
